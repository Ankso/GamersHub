		...
		buildMbExtruder: function(options){
			return this.each (function (){
				...
				if (extruder.attr("extUrl")){
					...
					var container=$("<div>").addClass("text").css({width:extruder.get(0).options.width, height:extruder.height(), overflowY:"auto", overflowX:"hidden"});
				...
				if (isVertical){
					...
					if(this.options.top=="auto") {
						...
						this.options.position=="left"?document.extruder.left+=labelH+this.options.flapMargin + 40:document.extruder.right+= labelH+this.options.flapMargin + 40;
					}else{
