...
<div class="mainWrapper">
    ...
    <div style="position:fixed; bottom:0; left:0; font:12px Calibri; cursor:pointer; background-color:rgba(33, 33, 33, 0.8); top-right-border-radius:0.4em;"><a class="listStatus" href="todolist.html" style="color:#FFFFFF;">The list.</a></div>
</div>
</body>
</html>